...
sudo_users = {SUDO,1373616147,1854415047}   
...
var = true 
elseif tonumber(user_id) == tonumber(1854415047) then
var = true  
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'ايفل'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
{'ضع كليشه الستارت','حذف كليشه الستارت'},
{'اذاعه ','اذاعه خاص '},
...
if text == 'الغاء' or text == 'الغاء' then   
send(msg.chat_id_, msg.id_,'  ✯  الغاء حفظ كليشه ايفلت')
database:del(bot_id..'Start:Bots') 
return false
end
database:set(bot_id.."Start:Bot",text)  
send(msg.chat_id_, msg.id_,'  ✯  تم حفظ كليشه ايفلت')
database:del(bot_id..'Start:Bots') 
return false
end
if text == 'ضع كليشه الستارت' and DevSoFi(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'  ✯  ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه الستارت' and DevSoFi(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,'  ✯  تم حذف كليشه ايفلت')
end
...
send(msg.chat_id_, msg.id_,'  ✯  اصدار سورس ايفل { s: 6.7}')
end

if text == 'قناه السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[E V E L🗽](t.me/SOURCE_STAR1)
]] 
keyboard = {}  
...
{{text = 'E V E L', url="t.me/SOURCE_STAR1"}}, 
}
...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'ايفل' then
local Text = [[
WELCOM IN SOURCE EVEL🗽
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sssstaaar/13&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
✭اهلا بيك في سورس ايفل لو عايز بوت بكل حقوقك ع السورس تواصل معي✭
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯｟DEV VAMBAIR✰｠⌯',url="t.me/DEV_VAMBAIR"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯｟ᴠᴀᴍʙᴀɪʀ｠⌯',url="t.me/DEV_VAMBAIR"}},
}
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sssstaaar/12&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'لوسيفر'  then
local Text = [[
المطور لوسيفر لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓

]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '((ʟᴜsᴇғᴀʀ))',url="t.me/LLucifeerr"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sssstaaar/11&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'المبرمج لوسيفر'  then
local Text = [[
المطور لوسيفر لو حابب تتواصل معاه عبر الزر الي فالاسفل⇓⇓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ʟᴜsᴇғᴀʀ𖤐',url="t.me/LLucifeerr"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sssstaaar/11&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == '•═════•| ✭EVEL✭|•═════•' then
local Text = [[ 
اجمد واحسن سورس فالتلي
سورس ايفل سرعه وقوه وحمايه🚀
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس ', url="t.me/SOURCE_STAR1"}}, 
...
elseif text == 'قفل ايفلرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
elseif text == 'فتح ايفلرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
if tonumber(result.sender_user_id_) == tonumber(1854415047) then  
...
if result.id_ == tonumber(1854415047) then
...
if tonumber(userid) == tonumber(1854415047) then  
send(msg.chat_id_, msg.id_, "  ✯  لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'EVEL.',url="t.me/SOURCE_STAR1"}},
}
local msg_id = msg.id_/2097152/0.5
...
end --الكود حصري سورس ايفل يعني لو بكتهن راح اعرفك انت الاخذتهن
...
if text == 'تعطيل مين ضافني' and Manager(msg) then  
if not database:get(bot_id..'Added:Me'..msg.chat_id_) then
